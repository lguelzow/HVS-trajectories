...
M1 = 0.5 * M_tot   # Mass of Milky Way
M2 = 0.5 * M_tot   # Mass of Andromeda
...
t = np.linspace(13800., 9990., 1000001)
...
def diff_eq(y0, t):
    ...
    dy1dt = [vx, G * (-1) * M_tot * rx / (mag_r ** 3)]
    # print(dy1dt)

    dy2dt = [vy, G * (-1) * M_tot * ry / (mag_r ** 3)]
    # print(dy2dt)

    dy3dt = [vz, G * (-1) * M_tot * rz / (mag_r ** 3)]
    # print(dy3dt)
